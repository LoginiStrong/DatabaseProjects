...
MEM_STATE VARCHAR(30) NOT NULL,
MEM_ZIP INTEGER NOT NULL,
MEM_BALANCE DECIMAL(8, 2) NOT NULL
);
...
MOVIE_COST DECIMAL(8, 2) NOT NULL,
MOVIE_GENRE VARCHAR(75) NOT NULL,
PRICE_CODE INTEGER,
...
DETAIL_FEE DECIMAL(8, 2) NOT NULL,
...
-- PROBLEM 49
UPDATE MOVIE SET MOVIE_YEAR = 2014 WHERE MOVIE_NUM = 1245;
...
-- PROBLEM 53
ALTER TABLE DETAILRENTAL MODIFY COLUMN 
DETAIL_RETURNDATE DATETIME;

UPDATE DETAILRENTAL
SET DETAIL_RETURNDATE = CONCAT(DETAIL_RETURNDATE, '10:00am')
WHERE RENT_NUM = 1001;

UPDATE DETAILRENTAL
SET DETAIL_RETURNDATE = CONCAT(DETAIL_RETURNDATE, '11:30am')
WHERE RENT_NUM = 1001 AND VID_NUM = 61353;

UPDATE DETAILRENTAL
SET DETAIL_RETURNDATE = CONCAT(DETAIL_RETURNDATE, '3:30pm')
WHERE RENT_NUM = 1002;

UPDATE DETAILRENTAL
SET DETAIL_RETURNDATE = CONCAT(DETAIL_RETURNDATE, '4:00pm')
WHERE RENT_NUM = 1003;

UPDATE DETAILRENTAL
SET DETAIL_RETURNDATE = CONCAT(DETAIL_RETURNDATE, '9:00am')
WHERE RENT_NUM = 1004;

UPDATE DETAILRENTAL
SET DETAIL_RETURNDATE = CONCAT(DETAIL_RETURNDATE, '12:30pm')
WHERE RENT_NUM = 1005;

UPDATE DETAILRENTAL
SET DETAIL_RETURNDATE = CONCAT(DETAIL_RETURNDATE, '10:15pm')
WHERE RENT_NUM = 1006 AND NOT NULL;

UPDATE DETAILRENTAL
SET DETAIL_RETURNDATE = CONCAT(DETAIL_RETURNDATE, '9:30pm')
WHERE RENT_NUM = 1008;
